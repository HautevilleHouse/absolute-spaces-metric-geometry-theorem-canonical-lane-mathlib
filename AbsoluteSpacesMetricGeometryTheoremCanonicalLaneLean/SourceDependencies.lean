...
/-!
# Source dependency model for `absolute-spaces-metric-geometry-theorem-canonical-lane`
...
def sourceImportDependencies : List SourceImportDependency := [
  ...
  { file := "scripts/extract_axioms.py", kind := "import", module := "datetime", name := "", alias := "", level := 0 },
  ...
  { file := "scripts/asmg_closure_guard.py", kind := "import", module := "datetime", name := "", alias := "", level := 0 },
  ...
  { file := "scripts/promote_constants.py", kind := "import", module := "datetime", name := "", alias := "", level := 0 },
  ...
  { file := "scripts/release_gate.py", kind := "import", module := "datetime", name := "", alias := "", level := 0 },
  ...
  { file := "scripts/update_manifest.py", kind := "import", module := "datetime", name := "", alias := "", level := 0 },
